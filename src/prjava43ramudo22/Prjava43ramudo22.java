package prjava43ramudo22; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
import java.io.*;
 
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava43ramudo22 extends Frame 
   ...
   public Prjava43ramudo22 () { 
      ...
      setTitle("nova finestra prjava43ramudo22");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43ramudo22();  // Let the construct do the job 
   } 
